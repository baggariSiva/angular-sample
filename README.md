...
<a href="https://dash.elest.io/deploy?source=cicd&social=Github&url=https://github.com/elestio-examples/angular"><img src="src\assets\files\deploy-on-elestio.png" alt="Deploy on Platform.sh" width="180px" /></a>

Example application and CI/CD pipeline showing how to deploy a Angular website to elestio.

<img src="src\assets\files\screenshot-1.jpg" alt="screenshot of the example app" width="100%" />
...
But for this Angular website example, you can choose GitHub as your deployment method.

### Step 3: Authentication

If you forked the repo then you can click on the sign-in with GitHub button and authorize elestio to access the git repo then you can select the Angular-example repo otherwise you can directly insert a git repo URL to deploy the Angular website.
